...
import 'package:petricad/widgets/custom_scrollable.dart';
  ...
  Widget build(BuildContext context) {
    ...
    Widget scrollable = CustomScrollable(
      ...
      viewportBuilder: (BuildContext context, ViewportOffset offset) {
        return _CustomSingleChildViewport(
          axisDirection: axisDirection,
          offset: offset,
...
class _CustomSingleChildViewport extends SingleChildRenderObjectWidget {
  const _CustomSingleChildViewport({
    Key? key,
  ...
  @override
  _CustomRenderSingleChildViewport createRenderObject(BuildContext context) {
    return _CustomRenderSingleChildViewport(
      axisDirection: axisDirection,
      offset: offset,
      clipBehavior: clipBehavior,
    );
  ...
  @override
  void updateRenderObject(BuildContext context, _CustomRenderSingleChildViewport renderObject) {
...
class _CustomRenderSingleChildViewport extends RenderBox with RenderObjectWithChildMixin<RenderBox> implements RenderAbstractViewport {
  _CustomRenderSingleChildViewport({
