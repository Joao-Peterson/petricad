                ...
                return Scrollbar(
                    ...
                    child: SingleChildScrollView(
                        ...
                        child: ChangeNotifierProvider(
                            create: (context) {
                              return _yScrollController;
                            },
                            child: Builder(
                                builder: (context) {
                                    return _CustomPaddingScrollbar(
                                        isAlwaysShown: widget.isAlwaysShown,
                                        trackVisibility: widget.trackVisibility,
                                        showTrackOnHover: widget.showTrackOnHover,
                                        hoverThickness: widget.hoverThickness,
...
class _CustomPaddingScrollbar extends StatelessWidget {
  
  const _CustomPaddingScrollbar({
    Key? key,
    required this.child,
    this.controller,
    this.isAlwaysShown,
...
class _MaterialCustomPaddingScrollbar extends _CustomPaddingRawScrollbar {
...
class _MaterialScrollbarState extends _CustomPaddingRawScrollbarState<_MaterialCustomPaddingScrollbar> {
...
class _CustomPaddingRawScrollbar extends StatefulWidget {

  const _CustomPaddingRawScrollbar({
    Key? key,
    required this.child,
    this.controller,
    this.isAlwaysShown,
  ...
  @override
  _CustomPaddingRawScrollbarState<_CustomPaddingRawScrollbar> createState() => _CustomPaddingRawScrollbarState<_CustomPaddingRawScrollbar>();
}

class _CustomPaddingRawScrollbarState<T extends _CustomPaddingRawScrollbar> extends State<T> with TickerProviderStateMixin<T> {
